...
Also check the lecture [slides](slides-04-03.html#/uml-diagram) on UML class diagrams.
...
..b..
```
The output should be printed to standard out.  See `TestCases/`
...
We recommend the following:
  ...
  * A Plant class hierarchy of some kind.  The design for this is what will be submitted for
    peer review on Tuesday March 13th at 11:30 am to Gradescope.
...
70% of this assignment grade will be correctness.  For this assignment, there
