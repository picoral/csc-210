...
See TestCases/\*.in for example input files.
...
Every time you commit changes to your GitHub repo, you will be able to see which grading test cases were passed/failed.
