...
**Week 5** `r schedule %>% filter(week == 5) %>% pull(dates)`: Review on Wednesday, Midterm on Friday
...
**Week 11** `r schedule %>% filter(week == 11) %>% pull(dates)`: Monday Review, Wednesday Midterm 2
