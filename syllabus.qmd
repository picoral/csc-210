...
**Week 3** `r schedule %>% filter(week == 3) %>% pull(dates)`: Java collections: arrays, lists, sets, and hashmaps
...
**Week 5** `r schedule %>% filter(week == 5) %>% pull(dates)`: classes, interfaces, trees and tree traversals, SAT problem

* PA3 due Wednesday, `r data %>% filter(Assignment == "PA3") %>%  select(Deadline)` at 11:30pm

**Week 6** `r schedule %>% filter(week == 6) %>% pull(dates)`: Midterm on Wednesday
...
**Week 11** `r schedule %>% filter(week == 11) %>% pull(dates)`: GUI Output

* PA7 due Wednesday, `r data %>% filter(Assignment == "PA7") %>%  select(Deadline)` at 11:30pm

**Week 12** `r schedule %>% filter(week == 12) %>% pull(dates)`: Wednesday Midterm 2
