...
**Week 5** `r schedule %>% filter(week == 6) %>% pull(dates)`: Midterm on Wednesday

**Week 6**  `r schedule %>% filter(week == 5) %>% pull(dates)`: classes, interfaces, trees and tree traversals, SAT problem
...
**Week 11** `r schedule %>% filter(week == 12) %>% pull(dates)`: Wednesday Midterm 2

**Week 12** `r schedule %>% filter(week == 11) %>% pull(dates)`: GUI Output
