...
you will create code to create a word search game. In the next assignment
you will create code for a user to play that game.
...
Here's an example output based on the input file given above:
